		...
		<>
			{
				cartItems.map((cart => {
					return (
						<div className={s.cart_card_block} key={cart.id}>
							...
							<div className={s.cart_card_block__about}>
								<div className={s.cart_card_block__about__header}>
									<h1>{cart.title}</h1>
									<div className={s.cart_card_block__about__desciption__count_mobile}>{cart.count}</div>
									<h2>{cart.price}</h2>
								</div>
								<div className={s.cart_card_block__about__desciption}>
									...
									<p className={s.cart_card_block__about__desciption__count}>Количество: <span>{cart.count}</span></p>
